setTimeout(async function () {
  ...
  const webSocketUrls = 'ws://localhost:62549/Regjeringen.Web/,wss://localhost:44395/Regjeringen.Web/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
